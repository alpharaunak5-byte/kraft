...
const sidebarItems = [
  ...
  { id: 'admin', label: 'Admin Controls', icon: Shield, color: 'text-red-600' },
    ...
    //  { id: 'strategy1', label: 'Campaign Studio', icon: Target, color: 'text-green-600' },
...
export const Sidebar: React.FC<SidebarProps> = ({ activeTab, onTabChange }) => {
  ...
  return (
    <div className={`w-16 md:w-56 ${themeClasses.cardBg} border-r ${themeClasses.border} h-screen flex flex-col transition-all duration-500`}>
