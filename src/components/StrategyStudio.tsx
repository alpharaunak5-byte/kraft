      ...
      <div className={`${themeClasses.cardBg} ${themeClasses.border} border-2 rounded-3xl p-8 ${themeClasses.shadow}`}>
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className={`${themeClasses.textSecondary}`}>
              Original campaign creation and management interface
            </p>
          </div>
        </div>

        {/* Legacy Campaign Form */}
        <div className="space-y-6">
          ...
          <div className="flex justify-end">
            <button className={`px-6 py-3 ${themeClasses.accent} text-white rounded-xl hover:opacity-90 transition-opacity`}>
              Create Campaign
            </button>
          </div>
        </div>
